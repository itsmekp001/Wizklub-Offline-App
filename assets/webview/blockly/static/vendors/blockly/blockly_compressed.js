...
goog.i18n.bidi.rtlLocalesRe_ =
  /^(ar|ckb|dv|he|iw|fa|nqo|ps|sd|ug|ur|yi|.*[-_](Adlm|Arab|Hebr|Thaa|Nkoo|Tfng))(?!.*[-_](Latn|Cyrl)($|-|_))($|-|_)/i;
...
goog.html.SafeUrl.fromFacebookMessengerUrl = function (a) {
  goog.string.caseInsensitiveStartsWith(a, "fb-messenger://share") ||
    (a = goog.html.SafeUrl.INNOCUOUS_STRING);
  return goog.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(a);
};
...
goog.dom.safe.setFormElementAction = function (a, b) {
  ...
  goog.dom.asserts.assertIsHTMLFormElement(a).action =
    goog.html.SafeUrl.unwrap(c);
};
goog.dom.safe.setButtonFormAction = function (a, b) {
  var c =
    b instanceof goog.html.SafeUrl
      ? b
      : goog.html.SafeUrl.sanitizeAssertUnchanged(b);
  goog.dom.asserts.assertIsHTMLButtonElement(a).formAction =
    goog.html.SafeUrl.unwrap(c);
};
goog.dom.safe.setInputFormAction = function (a, b) {
  var c =
    b instanceof goog.html.SafeUrl
      ? b
      : goog.html.SafeUrl.sanitizeAssertUnchanged(b);
  goog.dom.asserts.assertIsHTMLInputElement(a).formAction =
    goog.html.SafeUrl.unwrap(c);
};
...
goog.ui.Container.prototype.setKeyEventTarget = function (a) {
  if (this.focusable_) {
    ...
    throw Error(
      "can not set key event target for container that doesn't support keyboard focus!"
    );
};
        ...
        ("" == k
          ...
          : ((e = f.join("")),
            /[a-zA-Z][a-zA-Z0-9_]*/.test(e)
              ? ((k = e.toUpperCase()),
                (k = Blockly.utils.startsWith(k, "BKY_")
                  ? k.substring(4)
...
Blockly.Touch.isMouseOrTouchEvent = function (a) {
  return (
    Blockly.utils.startsWith(a.type, "touch") ||
    Blockly.utils.startsWith(a.type, "mouse") ||
    Blockly.utils.startsWith(a.type, "pointer")
  );
};
...
Blockly.VariableMap.prototype.deleteVariableById = function (a) {
  ...
  } else console.warn("can not delete non-existent variable: " + a);
};
...
Blockly.Events.Change.prototype.run = function (a) {
    ...
    switch (
      ...
      case "field":
        (b = b.getField(this.name))
          ...
          : console.warn("can not set non-existent field: " + this.name);
        break;
      case "comment":
  ...
  else console.warn("can not change non-existent block: " + this.blockId);
};
...
Blockly.Events.Create.prototype.run = function (a) {
  var b = this.getEventWorkspace_();
  if (a)
    (a = Blockly.Xml.utils.createElement("xml")),
    ...
    for (var c; (c = this.ids[a]); a++) {
      ...
      d
        ? d.dispose(!1, !1)
        : c == this.blockId &&
          console.warn("can not uncreate non-existent block: " + c);
    }
  }
};
  ...
  if (a) {
    ...
    for (var c; (c = this.ids[a]); a++) {
      ...
      d
        ? d.dispose(!1, !1)
        : c == this.blockId &&
          console.warn("can not delete non-existent block: " + c);
    }
  } else
    (a = Blockly.Xml.utils.createElement("xml")),
...
Blockly.Events.Move.prototype.run = function (a) {
  ...
  if (c) {
    ...
    if (d && ((f = b.getBlockById(d)), !f)) {
      console.warn("can not connect to non-existent block: " + d);
      return;
    }
    ...
    if (a) (e = c.getRelativeToSurfaceXY()), c.moveBy(a.x - e.x, a.y - e.y);
      ...
      g
        ? c.connect(g)
        : console.warn("can not connect to non-existent input: " + e);
    }
  } else console.warn("can not move non-existent block: " + this.blockId);
};
...
Blockly.Xml.variablesToDom = function (a) {
  for (
    var b = Blockly.Xml.utils.createElement("variables"), c = 0, d;
    (d = a[c]);
    c++
  ) {
...
Blockly.Xml.blockToDom = function (a, b) {
  ...
  e &&
    ((d = Blockly.Xml.utils.createElement("comment")),
    d.appendChild(Blockly.Xml.utils.createTextNode(e)),
    ...
    c.appendChild(d));
  a.data &&
    ((d = Blockly.Xml.utils.createElement("data")),
    d.appendChild(Blockly.Xml.utils.createTextNode(a.data)),
    c.appendChild(d));
  e = 0;
  for (var f; (f = a.inputList[e]); e++) {
    ...
    if (f.type != Blockly.DUMMY_INPUT) {
      ...
      f.type == Blockly.INPUT_VALUE
        ? (g = Blockly.Xml.utils.createElement("value"))
        : f.type == Blockly.NEXT_STATEMENT &&
          (g = Blockly.Xml.utils.createElement("statement"));
  ...
  if ((e = a.getNextBlock()))
    (g = Blockly.Xml.utils.createElement("next")),
      ...
      for (; b && !b.nextSibling; )
        (c = b),
          ...
          3 == c.nodeType &&
            "" == c.data.trim() &&
            b.firstChild != c &&
            Blockly.utils.removeNode(c);
      b &&
        ((c = b),
        (b = b.nextSibling),
        3 == c.nodeType && "" == c.data.trim() && Blockly.utils.removeNode(c));
    }
  return a;
};
...
Blockly.Events.CommentChange.prototype.run = function (a) {
  ...
  b
    ...
    : console.warn("can not change non-existent comment: " + this.commentId);
};
...
Blockly.Events.CommentCreateDeleteHelper = function (a, b) {
  ...
  if (b) {
    ...
    (c = c.getCommentById(a.commentId))
      ? c.dispose(!1, !1)
      : console.warn("can not uncreate non-existent comment: " + a.commentId);
};
...
Blockly.Events.CommentMove.prototype.run = function (a) {
  ...
  } else console.warn("can not move non-existent comment: " + this.commentId);
};
...
Blockly.SPRITE = { width: 40, height: 124, url: "delete.png"};
...
Blockly.Trashcan.prototype.dispose = function () {
  this.svgGroup_ &&
    (Blockly.utils.removeNode(this.svgGroup_), (this.svgGroup_ = null));
...
Blockly.WorkspaceDragSurfaceSvg.prototype.clearAndHide = function (a) {
  ...
  null != this.previousSibling_
    ? Blockly.utils.insertAfter(b, this.previousSibling_)
...
Blockly.WorkspaceSvg.prototype.getSvgXY = function (a) {
  var b = 0,
    ...
    d = 1;
  if (
    Blockly.utils.containsNode(this.getCanvas(), a) ||
    Blockly.utils.containsNode(this.getBubbleCanvas(), a)
  )
    d = this.scale;
  do {
...
Blockly.WorkspaceSvg.prototype.updateToolbox = function (a) {
  if ((a = Blockly.Options.parseToolboxTree(a))) {
    if (!this.options.languageTree)
      throw Error("Existing toolbox is null.  can not create new toolbox.");
    if (a.getElementsByTagName("category").length) {
      if (!this.toolbox_)
        throw Error(
          "Existing toolbox has no categories.  can not change mode."
        );
      ...
      if (!this.flyout_)
        throw Error("Existing toolbox has categories.  can not change mode.");
      this.options.languageTree = a;
      this.flyout_.show(a.childNodes);
    }
  } else if (this.options.languageTree)
    throw Error("can not nullify an existing toolbox.");
};
...
Blockly.WorkspaceSvg.setTopLevelWorkspaceMetrics_ = function (a) {
  if (!this.scrollbar)
    throw Error(
      "Attempt to set top level workspace scroll without scrollbars."
    );
  var b = this.getMetrics();
  "number" == typeof a.x &&
...
Blockly.Mutator.prototype.createEditor_ = function () {
  ...
  if (this.quarkNames_.length)
    for (
      var a = Blockly.Xml.utils.createElement("xml"), b = 0, c;
...
Blockly.Field.prototype.dispose = function () {
  ...
  this.fieldGroup_ &&
    (Blockly.utils.removeNode(this.fieldGroup_), (this.fieldGroup_ = null));
...
Blockly.FieldLabel.prototype.dispose = function () {
  this.textElement_ &&
    (Blockly.utils.removeNode(this.textElement_), (this.textElement_ = null));
};
...
Blockly.Block.prototype.setColour = function (a) {
  ...
  else if ("string" == typeof b && /^#[0-9a-fA-F]{6}$/.test(b))
...
Blockly.Block.prototype.interpolate_ = function (a, b, c) {
  ...
  a.length &&
    ("string" == typeof a[a.length - 1] ||
      Blockly.utils.startsWith(a[a.length - 1].type, "field_")) &&
...
Blockly.Block.prototype.moveNumberedInputBefore = function (a, b) {
  if (a == b) throw Error("can not move input to itself.");
...
Blockly.BlockSvg.prototype.renderExternalValueInput_ = function (
  a,
  b,
  c,
  d,
...
Blockly.FieldColour.prototype.showEditor_ = function () {
  ...
  Blockly.FieldColour.onUpWrapper_ = Blockly.bindEvent_(
    c,
    "mouseup",
    this,
    this.onClick_
...
Blockly.FieldColour.widgetDispose_ = function () {
  Blockly.FieldColour.onUpWrapper_ &&
...
Blockly.Procedures.flyoutCategory = function (a) {
  ...
  if (Blockly.Blocks.procedures_defnoreturn) {
    ...
    e.appendChild(
      Blockly.Xml.utils.createTextNode(
  ...
  Blockly.Blocks.procedures_defreturn &&
    ((d = Blockly.Xml.utils.createElement("block")),
    d.setAttribute("type", "procedures_defreturn"),
    d.setAttribute("gap", 16),
    (e = Blockly.Xml.utils.createElement("field")),
    e.setAttribute("name", "NAME"),
    e.appendChild(
      Blockly.Xml.utils.createTextNode(
...
Blockly.Css.CONTENT = [
  ...
  "background: url(<<<PATH>>>/delete.png) no-repeat -48px -16px !important;",
  "}",
  ".blocklyToolboxDiv {",
...
Blockly.inject = function (a, b) {
  ...
  if (!Blockly.utils.containsNode(document, a))
...
Blockly.createMainWorkspace_ = function (a, b, c, d) {
  ...
  !b.hasCategories &&
    b.languageTree &&
    ((c = e.addFlyout_("svg")), Blockly.utils.insertAfter(c, a));
  e.translate(0, 0);
    ...
    if (27 == a.keyCode) Blockly.hideChaff();
      ...
      86 == a.keyCode
        ? Blockly.clipboardXml_ &&
          (Blockly.Events.setGroup(!0),
          (b = Blockly.clipboardSource_),
          b.isFlyout && (b = b.targetWorkspace),
          b.paste(Blockly.clipboardXml_),
          Blockly.Events.setGroup(!1))
