...
Blockly.JavaScript["RGB"] = function (block) {
  ...
  return "requestRGBChange(" + value + "," + value1 + "," + value2 + ");\n";
  //return 'MusicMaker.queueSound1(' + value + ');\n';
};
...
Blockly.JavaScript["color"] = function (block) {
  ...
  return "requestColorChange(" + value + "," + 5 + ");\n";
};

Blockly.defineBlocksWithJsonArray([
  {
    type: "wiz_color_power",
    message0: "Color %1 power %2",
    args0: [
      {
        type: "field_dropdown",
        name: "VALUE",
...
Blockly.JavaScript["wiz_color_power"] = function (block) {
  var value = "'" + block.getFieldValue("VALUE") + "'";
  var value1 = "'" + block.getFieldValue("VALUE1") + "'";
  //return 'MusicMaker.Wizcolour(' + value + ');\n';
  return "requestColorpower(" + value + "," + value1 + ");\n";
};

Blockly.defineBlocksWithJsonArray([
  {
    type: "wiz_color_time",
    message0: "Color %1 Seconds %2",
    args0: [
      {
        type: "field_dropdown",
        name: "VALUE",
...
Blockly.JavaScript["wiz_color_time"] = function (block) {
  var value = "'" + block.getFieldValue("VALUE") + "'";
  var value1 = "'" + block.getFieldValue("VALUE1") + "'";
  //return 'MusicMaker.Wizcolour(' + value + ');\n';
  return "requestColorChange(" + value + "," + value1 + ");\n";
};
...
Blockly.JavaScript["prebuild"] = function (block) {
  var value = "'" + block.getFieldValue("VALUE") + "'";
  //return 'MusicMaker.Wizcolour(' + value + ');\n';
  return "requestPrebuild(" + value + ");\n";
};

Blockly.defineBlocksWithJsonArray([
  {
    type: "LED_RGB",
    message0: "Led %1 Red %2 Green %3 Blue %4 power %5 ",
    args0: [
      {
        type: "field_dropdown",
        name: "VALUE",
...
Blockly.defineBlocksWithJsonArray([
  {
    type: "wiz_led_color_power",
    message0: "Led %1 Color %2 Power %3",
    args0: [
      {
        type: "field_dropdown",
        name: "VALUE",
...
Blockly.JavaScript["wiz_led_color_power"] = function (block) {
  var value = "'" + block.getFieldValue("VALUE") + "'";
  var value1 = "'" + block.getFieldValue("VALUE1") + "'";
  var value2 = "'" + block.getFieldValue("VALUE2") + "'";
  //return 'MusicMaker.Wizcolour(' + value + ');\n';
  return "requestledColorpower(" + value + "," + value1 + "," + value2 + ");\n";
};

Blockly.defineBlocksWithJsonArray([
  {
    type: "wiz_single_led_color_power",
    message0: "Led %1 Color %2 Power %3",
    args0: [
      {
        'type': 'input_value',
...
Blockly.JavaScript["wiz_single_led_color_power"] = function (block) {
  let value = Blockly.JavaScript.valueToCode(block, "VALUE3", Blockly.JavaScript.ORDER_ATOMIC);
  var value1 = "'" + block.getFieldValue("VALUE1") + "'";
  var value2 = "'" + block.getFieldValue("VALUE2") + "'";
  //return 'MusicMaker.Wizcolour(' + value + ');\n';
  return "requestledColorpower(" + value + "," + value1 + "," + value2 + ");\n";
...
Blockly.defineBlocksWithJsonArray([
  {
    type: "wiz_led_color_time",
    message0: "Led %1 Color %2 Seconds %3",
    args0: [
      {
        type: "field_dropdown",
        name: "VALUE",
...
Blockly.JavaScript["wiz_led_color_time"] = function (block) {
  var value = "'" + block.getFieldValue("VALUE") + "'";
  var value1 = "'" + block.getFieldValue("VALUE1") + "'";
  var value2 = "'" + block.getFieldValue("VALUE2") + "'";
  //return 'MusicMaker.Wizcolour(' + value + ');\n';
  return "requestledColortime(" + value + "," + value1 + "," + value2 + ");\n";
};
